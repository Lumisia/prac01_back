...
public class SimpleApp {
    ...
    //  @Before("execution(* com.example.demo.board..*.*(..))")
    //  Pointcut을 안만들어두면 이렇게 설정해야 함.
    @Before("cut()") // 포인트 컷에서 지정한 위치의 클래스의 메소드가 실행되기 전에 현재 메소드를 실행
    // JoinPoint joinPoint : 위치나 시점 특정 클래스, 특정 메소드라는 정보
    ...
    //  @Before("execution(* com.example.demo.board..*.*(..))")
    //  Pointcut을 안만들어두면 이렇게 설정해야 함.
    @After("cut()") // 포인트 컷에서 지정한 위치의 클래스의 메소드가 실행되기 전에 현재 메소드를 실행
    // JoinPoint joinPoint : 위치나 시점 특정 클래스, 특정 메소드라는 정보
    ...
    @Around("cut()") // 포인트 컷에서 지정한 위치의 클래스의 메소드가 실행되기 전에 현재 메소드를 실행
    // JoinPoint joinPoint : 위치나 시점 특정 클래스, 특정 메소드라는 정보
    private Object traceMethod(ProceedingJoinPoint joinPoint) throws Throwable{
